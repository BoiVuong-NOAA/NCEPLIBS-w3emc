...
contains
  ...
  SUBROUTINE WRGI1H(LUGI,NLEN,NNUM,CGB)
    ...
    character(len=81) :: chead(2) ! CHEAD(2)*81
    
    integer :: n, kw, hostname, ncgb, ncgb1, ncgb2
    ...
    CHEAD(1)(56:70)="hostname"!HOSTNAM(hostname)
    CHEAD(1)(72:81)='testw3emc '
    !CHEAD(1)(82:82)=CHAR(10)

    ! FILL SECOND 83-BYTE HEADER
    CHEAD(2)='IX1FORM:'
...
end module w3emc_test_functions

PROGRAM test_w3emc
  use w3emc_test_functions
  implicit none
  ! C
  ...
  integer :: ier, ios, iret, iw, krew, irgi, j, lgrib, lugb, lugi, kw ,lcarg, mnum, n, ncgb, ncgi, ncgrib, ns, nlen, nnum
...
2802 FORMAT(1X,A5,1X,A,/,6X,A25,A18,A2,A12,1X,I0)
  ...
  IF (NNUM.GT.0) THEN
     NCGRIB=0
     DO WHILE(CGRIB(NCGRIB+1:NCGRIB+1).NE.' ')
        NCGRIB=NCGRIB+1
     ENDDO
